...
export const thresholds = {
    ...
    'JR': { points: 1000, salary: 15, title: "Jr. Developer", color: "green", icon: jrIconURL },
    'DEV_1': { points: 1500, salary: 20, title: "Developer I", color: "purple", icon: dev1IconURL },
    'DEV_2': { points: 2000, salary: 25, title: "Developer II", color: "orange", icon: dev2IconURL },
    'DEV_3': { points: 2500, salary: 30, title: "Developer III", color: "yellowgreen", icon: dev3IconURL },
    'SR': { points: 1000000, salary: 40, title: "Sr. Developer", color: "red", icon: srIconURL }
};
